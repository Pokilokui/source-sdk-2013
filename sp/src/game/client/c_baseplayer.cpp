...
ConVar mat_player_shadow("mat_player_shadow", 0, FCVAR_ARCHIVE, "Allow casting playermodel shadow");
...
void C_BasePlayer::CalcThirdPersonDeathView(Vector& eyeOrigin, QAngle& eyeAngles, float& fov)	//Third person death
{
