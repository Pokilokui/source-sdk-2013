...
IMPLEMENT_CLIENTCLASS_DT(C_BaseHLPlayer, DT_HL2_Player, CHL2_Player)
	...
	RecvPropEHandle(RECVINFO(m_hRagdoll)),		//First person ragdoll
END_RECV_TABLE()
...
void C_BaseHLRagdoll::CreateHL2Ragdoll(void)		//First person ragdoll
{
...
void C_BaseHLPlayer::CalcDeathCamView(Vector& eyeOrigin, QAngle& eyeAngles, float& fov)		//First person ragdoll
{
