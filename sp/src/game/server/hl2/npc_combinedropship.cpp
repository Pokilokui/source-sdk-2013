...
protected:
	...
	static int m_poseBody_Accel, m_poseBody_Sway, m_poseCargo_Body_Accel, m_poseCargo_Body_Sway;
		//m_poseWeapon_Pitch, m_poseWeapon_Yaw;		//Fix gun rotation
...
//int CNPC_CombineDropship::m_poseWeapon_Pitch = 0;		//Fix gun rotation
//int CNPC_CombineDropship::m_poseWeapon_Yaw = 0;		//Fix gun rotation
...
void	CNPC_CombineDropship::PopulatePoseParameters( void )
{
	if (!m_sbStaticPoseParamsLoaded)
	{
		...
		//m_poseWeapon_Pitch		= LookupPoseParameter( "weapon_pitch" );	//Fix gun rotation
		//m_poseWeapon_Yaw		= LookupPoseParameter( "weapon_yaw" );			//Fix gun rotation
