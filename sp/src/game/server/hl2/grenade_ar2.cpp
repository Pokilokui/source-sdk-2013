...
BEGIN_DATADESC( CGrenadeAR2 )
	...
	DEFINE_FIELD( m_vecVelocity, FIELD_VECTOR ), //func_breakable
	DEFINE_FIELD( m_bTouched, FIELD_BOOLEAN ),   //same
...
//	UTIL_SetSize(this, Vector(0, 0, 0), Vector(0, 0, 0));
	...
	m_bIsLive		= true;
	m_iHealth		= 1;
	m_bTouched		= false;	//func_breakable
	m_vecVelocity	= vec3_origin; //same
