...
public:
	...
	virtual void		CreateRagdollEntity();								//First person ragdoll
	...
	// Tracks our ragdoll entity. For first person ragdoll
...
class CHL2Ragdoll : public CBaseAnimatingOverlay			//First person ragdoll
{
public:
