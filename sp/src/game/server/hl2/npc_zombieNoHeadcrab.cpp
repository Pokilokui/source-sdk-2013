...
envelopePoint_t envZombieMoanVolumeNoHeadcrabNoHeadcrabFast[] =
{
	{	7.0f, 7.0f,
		0.1f, 0.1f,
	},
...
envelopePoint_t envZombieMoanVolumeNoHeadcrabNoHeadcrab[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.1f,
	},
...
envelopePoint_t envZombieMoanVolumeNoHeadcrabLong[] =
{
	{	1.0f, 1.0f,
		0.3f, 0.5f,
	},
...
LINK_ENTITY_TO_CLASS(npc_zombie_no, CZombie);
...
void CZombie::Spawn( void )
{
	...
	if( FClassnameIs( this, "npc_zombie_no" ) )
	{
		m_fIsTorso = false;
	}
	else
...
AI_BEGIN_CUSTOM_NPC( npc_zombie_no, CZombie )
