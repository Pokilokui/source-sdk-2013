...
//
// Purpose: Famas !!! Ma France, mon saucisson, mon pinard !
//
//=============================================================================//
...
class CWeaponFamas : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponFamas, CHLMachineGun);
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponFamas::Precache(void)
{
...
//-----------------------------------------------------------------------------
void CWeaponFamas::Equip(CBaseCombatCharacter* pOwner)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
/*void CWeaponFamas::SecondaryAttack(void)
{
...
// Output : int
//-----------------------------------------------------------------------------
//int CWeaponFamas::WeaponRangeAttack2Condition( float flDot, float flDist )
/*int CWeaponFamas::WeaponRangeAttack2Condition()
{
