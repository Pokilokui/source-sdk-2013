...
#define	DEAGLE_FASTEST_REFIRE_TIME		0.3f
#define	DEAGLE_FASTEST_DRY_REFIRE_TIME	0.3f

#define	DEAGLE_ACCURACY_SHOT_PENALTY_TIME		0.3f	// Applied amount of time each shot adds to the time we must recover from
