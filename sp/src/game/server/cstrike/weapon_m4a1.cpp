...
public:
	...
	float	GetFireRate(void) { return 0.093f; }	// 13.3hz
...
// Output : int
//-----------------------------------------------------------------------------
//int CWeaponM4A1::WeaponRangeAttack2Condition( float flDot, float flDist )
/*int CWeaponM4A1::WeaponRangeAttack2Condition()
{
