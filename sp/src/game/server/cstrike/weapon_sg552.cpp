...
//
// Purpose: ATTENTION: not to be confused with weapon_sgg_550 !!!
// TODO: make only one level of zooming
//
//=============================================================================//
...
// Output : int
//-----------------------------------------------------------------------------
//int CWeaponSG552::WeaponRangeAttack2Condition( float flDot, float flDist )
/*int CWeaponSG552::WeaponRangeAttack2Condition()
{
