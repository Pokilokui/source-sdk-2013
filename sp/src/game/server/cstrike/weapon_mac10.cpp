...
class CWeaponMac10 : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponMac10, CHLMachineGun);
...
// Purpose: 
//-----------------------------------------------------------------------------
/*void CWeaponMac10::SecondaryAttack(void)
{
...
/*int CWeaponMac10::WeaponRangeAttack2Condition()
{
