...
class CWeaponScout : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponScout, CBaseHLCombatWeapon);
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponScout::CapabilitiesGet(void) const
{
...
//-----------------------------------------------------------------------------
bool CWeaponScout::Holster(CBaseCombatWeapon* pSwitchingTo)
{
...
void CWeaponScout::SecondaryAttack(void)
{
...
//-----------------------------------------------------------------------------
const Vector& CWeaponScout::GetBulletSpread(void)
{
