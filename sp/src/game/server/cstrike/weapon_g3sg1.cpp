...
class CWeaponG3SG1 : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponG3SG1, CBaseHLCombatWeapon);
...
// Purpose: Constructor.
//-----------------------------------------------------------------------------
CWeaponG3SG1::CWeaponG3SG1(void)
{
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponG3SG1::CapabilitiesGet(void) const
{
...
//-----------------------------------------------------------------------------
bool CWeaponG3SG1::Holster(CBaseCombatWeapon* pSwitchingTo)
{
...
//-----------------------------------------------------------------------------
void CWeaponG3SG1::ItemPostFrame(void)
{
	CBasePlayer* pPlayer = ToBasePlayer(GetOwner());
	if (pPlayer == NULL)
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponG3SG1::Precache(void)
{
	BaseClass::Precache();
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponG3SG1::PrimaryAttack(void)
{
...
void CWeaponG3SG1::SecondaryAttack(void)
{
...
//-----------------------------------------------------------------------------
const Vector& CWeaponG3SG1::GetBulletSpread(void)
{
...
//			*pOperator - 
//-----------------------------------------------------------------------------
void CWeaponG3SG1::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	switch (pEvent->event)
	{
