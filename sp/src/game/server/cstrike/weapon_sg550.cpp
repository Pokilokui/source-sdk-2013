...
class CWeaponSG550 : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponSG550, CHLMachineGun);
	...
	float	GetFireRate(void) { return 0.225f; }	// 13.3hz
...
acttable_t	CWeaponSG550::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponSG550);
...
//-----------------------------------------------------------------------------
bool CWeaponSG550::Holster(CBaseCombatWeapon* pSwitchingTo)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSG550::Precache(void)
{
...
//-----------------------------------------------------------------------------
void CWeaponSG550::Equip(CBaseCombatCharacter* pOwner)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSG550::FireNPCPrimaryAttack(CBaseCombatCharacter* pOperator, Vector& vecShootOrigin, Vector& vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSG550::Operator_ForceNPCFire(CBaseCombatCharacter* pOperator, bool bSecondary)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSG550::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	switch (pEvent->event)
	{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponSG550::GetPrimaryAttackActivity(void)
{
	if (m_nShotsFired < 2)
...
void CWeaponSG550::SecondaryAttack(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSG550::AddViewKick(void)
{
...
// Output : int
//-----------------------------------------------------------------------------
//int CWeaponSG550::WeaponRangeAttack2Condition( float flDot, float flDist )
/*int CWeaponSG550::WeaponRangeAttack2Condition()
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t* CWeaponSG550::GetProficiencyValues()
{
