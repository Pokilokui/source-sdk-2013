...
class CWeaponM249 : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponM249, CHLMachineGun);
...
acttable_t	CWeaponM249::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponM249);
...
//-----------------------------------------------------------------------------
void CWeaponM249::Equip(CBaseCombatCharacter* pOwner)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponM249::FireNPCPrimaryAttack(CBaseCombatCharacter* pOperator, Vector& vecShootOrigin, Vector& vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponM249::Operator_ForceNPCFire(CBaseCombatCharacter* pOperator, bool bSecondary)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponM249::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	switch (pEvent->event)
	{
...
// Output : int
//-----------------------------------------------------------------------------
//int CWeaponM249::WeaponRangeAttack2Condition( float flDot, float flDist )
/*int CWeaponM249::WeaponRangeAttack2Condition()
{
