...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAug::FireNPCPrimaryAttack(CBaseCombatCharacter* pOperator, Vector& vecShootOrigin, Vector& vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAug::Operator_ForceNPCFire(CBaseCombatCharacter* pOperator, bool bSecondary)
{
 ...
 */
bool CWeaponAug::Holster(CBaseCombatWeapon* pSwitchingTo /* = NULL  */)
{
	if (m_bInZoom)
	{
		ToggleZoom();
...
* Check the status of the zoom key every frame to see if player is still zoomed in
*/
void CWeaponAug::ItemBusyFrame(void)
{
 ...
 */
void CWeaponAug::CheckZoomToggle(void)
{
 ...
 */
void CWeaponAug::ToggleZoom(void)
{
	CBasePlayer* pPlayer = ToBasePlayer(GetOwner());
	...
	if (m_bInZoom)
	{
		...
		if (pPlayer->SetFOV(this, 0, 0.2f))
		{
			...
			//Disable this or the game will crash
...
// Output : int
//-----------------------------------------------------------------------------
//int CWeaponAug::WeaponRangeAttack2Condition( float flDot, float flDist )
/*int CWeaponAug::WeaponRangeAttack2Condition()
{
