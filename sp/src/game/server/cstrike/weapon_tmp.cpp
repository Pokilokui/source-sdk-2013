...
class CWeaponTMP : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponTMP, CHLMachineGun);
...
//-----------------------------------------------------------------------------
void CWeaponTMP::Equip(CBaseCombatCharacter* pOwner)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
/*void CWeaponTMP::SecondaryAttack(void)
{
...
// Output : int
//-----------------------------------------------------------------------------
//int CWeaponTMP::WeaponRangeAttack2Condition( float flDot, float flDist )
/*int CWeaponTMP::WeaponRangeAttack2Condition()
{
