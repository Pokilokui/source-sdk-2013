...
#define BINOCULARS_ZOOM_RATE		0.25
...
{
	m_flNextPrimaryAttack = gpGlobals->curtime + BINOCULARS_ZOOM_RATE;
	Zoom(Zoom_In);
}

void CWeaponBinoculars::SecondaryAttack(void)
{
	m_flNextSecondaryAttack = gpGlobals->curtime + BINOCULARS_ZOOM_RATE;
	Zoom(Zoom_Out);
}
...
void CWeaponBinoculars::Precache( void )
{
	...
	BaseClass::Precache();
	PrecacheScriptSound("Weapon_Binoculars.Special1");
	PrecacheScriptSound("Weapon_Binoculars.Special2");
	PrecacheScriptSound("Weapon_Binoculars.Reload");
