...
#define CONSUME_OBJECT_SOUND "Weapon_Proto1.Consume"
...
acttable_t CWeaponProto1::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponProto1);
...
bool CWeaponProto1::CanConsumeObject( CBaseEntity *pObject )
{
	...
	if( !pPhysObject )
	{
		...
		DevMsg("Object does not have VPhysics\n");
		return false;
	}
