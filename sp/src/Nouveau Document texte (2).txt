...
// HL2MP Stunstick ported by Mazdo for Source 2013 SP Branch
// Thank to TheMaster974 for the tutorial !!!
// Server Side code of weapon_stunsick
// d1_trainstation_04 couldn't be passed because of the code, so i fixed it
// $NoKeywords: $
//=============================================================================//
...
void CWeaponStunStick::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	...
	case EVENT_WEAPON_MELEE_HIT:
	{
		...
		if (pHurt)
		{
			...
			// Need this code if you're playing on d1_trainstation_04
...
void CWeaponStunStick::PrimaryAttack()
{
	...
	{
		pPlayer->TakeDamage(CTakeDamageInfo(this, pPlayer, 35, DMG_SHOCK)); // 50 damage is just a placeholder value!
	}
